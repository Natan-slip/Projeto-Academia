	...
	public void criarTela() {
		...
		buttonCalcular.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				cliente.setSexo(radioMasculino.getText());
				cliente.setSexo(radioFeminino.getText());
				
				cliente.setSexo(radioMasculino.isSelected()?"Masculino":"Feminino");
